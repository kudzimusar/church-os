      ...
      <div className="max-w-screen-xl mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-16">
        ...
        <div className="space-y-8">
          ...
          <div className="flex flex-col gap-4 text-sm font-bold">
            ...
            <a href="#" className="text-white/60 hover:text-[var(--primary)] transition-colors">Privacy Policy</a>
            <a href="#" className="text-white/60 hover:text-[var(--primary)] transition-colors">Terms of Service</a>
            
            <div className="pt-4 border-t border-white/5">
              <p className="text-[10px] font-black uppercase tracking-widest text-white/30 mb-2">Internal</p>
              <a href="/jkc-devotion-app/" className="text-white/60 hover:text-[var(--primary)] transition-colors">Client Login</a>
            </div>
          </div>
        </div>
      </div>
