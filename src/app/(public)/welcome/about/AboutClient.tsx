  ...
  return (
    <div className="pt-16 min-h-screen" style={{ background: 'var(--background)' }}>
      ...
      <section className="relative overflow-hidden min-h-[80vh] flex items-center" style={{ backgroundColor: '#EE9B33' }}>
        ...
        <div id="pastor" className="max-w-screen-xl mx-auto px-6 w-full relative z-10 py-12 md:py-20">
      ...
      <section id="history" className="py-24 px-6" style={{ background: 'var(--jkc-navy)' }}>
      ...
      <section id="faith" className="py-24 px-6" style={{ background: 'var(--section-alt)' }}>
      ...
      {/* SECTION 5: JAPAN & BAPTISM (Deep Links) */}
      <section className="py-24 px-6 border-t" style={{ background: 'var(--background)', borderColor: 'var(--border)' }}>
        <div className="max-w-screen-xl mx-auto grid md:grid-cols-2 gap-16">
          <div id="japan" className="space-y-6">
            <h3 className="text-3xl font-black italic" style={{ color: 'var(--foreground)' }}>Christianity in Japan</h3>
            <div className="w-12 h-1 bg-[var(--jkc-navy)]" />
            <p className="text-lg leading-relaxed font-medium" style={{ color: 'var(--muted-foreground)' }}>
              With less than 1% of the population identifying as Christian, Japan is one of the largest unreached 
              people groups in the world. Japan Kingdom Church is committed to being a lighthouse in Tokyo, 
              sharing the love of Christ in a way that respects Japanese culture while remaining true to the Gospel.
            </p>
          </div>
          <div id="baptism" className="space-y-6">
            <h3 className="text-3xl font-black italic" style={{ color: 'var(--foreground)' }}>Baptism at JKC</h3>
            <div className="w-12 h-1 bg-[var(--jkc-gold)]" />
            <p className="text-lg leading-relaxed font-medium" style={{ color: 'var(--muted-foreground)' }}>
              We believe baptism is a public declaration of faith and a vital step in the Christian journey. 
              At JKC, we hold baptism services regularly for those who have made a commitment to follow Christ. 
              If you are interested in being baptized in Japan, please reach out to our team.
            </p>
          </div>
        </div>
      </section>
