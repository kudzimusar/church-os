...
const outreachPrograms = [
  {
    ...
    frequency: 'Monthly',
    image: '/images/outreach_toyoko.png',
    color: '#8B5CF6',
  ...
  },
  {
    ...
    image: '/images/outreach_akiramenai.png',
    color: '#EF4444',
  ...
  },
  {
    ...
    image: '/images/ministry_foodpantry_card.png',
    color: '#F59E0B',
    signupUrl: 'https://www.japankingdomchurch.com/contact',
    donateUrl: 'https://www.japankingdomchurch.com/give',
  },
  {
    ...
    frequency: 'TBD',
    image: '/images/outreach_street_evangelism.png',
    color: '#10B981',
    signupUrl: 'https://www.japankingdomchurch.com/contact',
    donateUrl: 'https://www.japankingdomchurch.com/give',
  },
    ...
    <div className="min-h-screen pt-16" style={{ background: 'var(--background)' }}>
      ...
      <section className="relative py-40 px-6 overflow-hidden bg-slate-900">
        <div className="absolute inset-0">
          <img
            src="/images/outreach_akiramenai.png"
            alt="JKC Outreach"
