...
const DASHBOARD_PATH = "/ministry-dashboard";
...
export default function MinistryLoginPage() {
    ...
    const handleLogin = async (e: React.FormEvent) => {
        ...
        if (membershipError || !membershipData || membershipData.length === 0) {
            ...
            setError("Access denied: You do not have ministry access.");
            setLoading(false);
            return;
        }
        ...
        <div className="min-h-screen bg-[#080c14] flex items-center justify-center p-4 relative overflow-hidden">
            ...
            >
                ...
                <div className="flex flex-col items-center mb-8">
                    ...
                    <p className="text-sm text-white/40 mt-1 font-medium">Ministry Dashboard — Leader Access</p>
                </div>

                {/* Card */}
                <div className="bg-[#0d1421] border border-white/8 rounded-3xl p-8 shadow-2xl">
                    <div className="mb-6">
                        <h2 className="text-lg font-black text-white">Ministry Sign In</h2>
                        <p className="text-xs text-white/40 mt-1">
                            Access restricted to assigned ministry leaders
                        </p>
                    </div>
                    ...
                    <form onSubmit={handleLogin} className="space-y-4">
                        ...
                        <div className="space-y-1.5">
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    placeholder="leader@ministry.com"
                        ...
                        >
                            {loading ? (
                                ...
                                <><ShieldCheck className="w-4 h-4" /> Access Ministry Dashboard</>
                            )}
                        </button>
                    </form>
                ...
                <div className="flex items-center justify-center gap-2 mt-4">
                    ...
                    <p className="text-[9px] text-white/20 font-medium uppercase tracking-widest">
                        SECURED BY SUPABASE AUTH · MINISTRY INTELLIGENCE PLATFORM
                    </p>
                </div>
            </motion.div>
        </div>
